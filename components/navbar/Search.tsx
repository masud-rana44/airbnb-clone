...
export const Search = () => {
  ...
  const locationValue = searchPrams?.get("locationValue");
  const startDate = searchPrams?.get("startDate");
  const endDate = searchPrams?.get("endDate");
  const guestCount = searchPrams?.get("guestCount");
